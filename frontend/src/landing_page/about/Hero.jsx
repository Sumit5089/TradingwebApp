...
function Hero() {
    return ( 
        ...
        <div className="container mt-5 p-5 ">
            <div className='mt-5 p-5 border-bottom'>
            <h2 className='text-center' style={{fontSize:"32px"}}>We pioneered the discount broking model in India.</h2>
            <h2 className='text-center' style={{fontSize:"32px"}}>Now, we are breaking ground with our technology.</h2>
            </div>
            <div className="row mt-5 p-5" style={{fontSize:"1rem"}}>
                <div className="col">
